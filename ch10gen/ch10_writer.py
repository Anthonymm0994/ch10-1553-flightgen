...
class Ch10Writer:
    ...
    def _write_tmats_packet(self, scenario_name: str, icd: ICDDefinition,
        ...
        # Note: PyChapter10 doesn't use data_type field, relies on channel_id
    ...
    def _write_1553_packets(self, schedule: BusSchedule,
        ...
        for sched_msg in schedule.messages:
            ...
            MAX_MESSAGES_PER_PACKET = 50
            
            # Check if we should start a new packet
            if (len(packet_messages) >= MAX_MESSAGES_PER_PACKET or 
                packet_size + msg_size > self.config.target_packet_bytes) and packet_messages:
    ...
    def _write_1553_packet(self, messages: List[ScheduledMessage],
        ...
        for sched_msg in messages:
            ...
            msg.ipts = int(msg_time_relative_s * 1_000_000_000)
            ...
            msg.data = b''.join(struct.pack('<H', word) for word in message_words)
