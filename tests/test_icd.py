...
class TestMessageDefinition:
    ...
    def test_invalid_rate(self):
        ...
        errors = msg.validate()
        assert any('invalid rate' in e for e in errors)
    ...
    def test_invalid_rt_sa(self):
        ...
        errors = msg.validate()
        assert any('invalid RT' in e for e in errors)
        
        # Invalid SA
        msg.rt = 5
        msg.sa = 32  # > 31
        errors = msg.validate()
        assert any('invalid SA' in e for e in errors)
    ...
    def test_invalid_transfer_type(self):
        ...
        errors = msg.validate()
        assert any('invalid transfer type' in e for e in errors)
    ...
    def test_word_count_mismatch(self):
        ...
        errors = msg.validate()
        assert any('word count mismatch' in e for e in errors)
